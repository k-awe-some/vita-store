      ...
      <div className={card.animation}>
        <div className="front" onClick={() => showBack(card)}>
          ...
          <div className="card-container">
            ...
            <p>
              Need a jum on your vitamins while drinking? Tired of popping
              pills? Drink our vitamin enhanced juice!
            </p>
          </div>
        </div>

        <div
          className="card-container-back back"
          onClick={() => showFront(card)}
        >
          <h3>
            Vitamin Juice <span className="price">$24.99</span>{" "}
          </h3>
